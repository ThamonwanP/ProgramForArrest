...
public class SearchbyFidLeft_Result
{
    public SearchbyFidLeft_ResultData[] Property1 { get; set; }
}

public class SearchbyFidLeft_ResultData
{
    ...
    public SearchbyFidLeft_ResultData_Birthday birthday { get; set; }
...
public class SearchbyFidLeft_ResultData_Birthday
{
