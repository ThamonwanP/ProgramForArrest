...
class getAllpersonbyOrg
{
    public getAllpersonbyOrg_data[] Property1 { get; set; }
}

public class getAllpersonbyOrg_data
{
    ...
    public getAllpersonbyOrg_dataBirthday birthday { get; set; }
...
public class getAllpersonbyOrg_dataBirthday
{
