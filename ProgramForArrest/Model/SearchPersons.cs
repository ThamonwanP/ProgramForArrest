...
{
    public SearchPersons_data[] Property2 { get; set; }
}

public class SearchPersons_data
{
    ...
    public SearchPersons_Birthday birthday { get; set; }
...
public class SearchPersons_Birthday
{
