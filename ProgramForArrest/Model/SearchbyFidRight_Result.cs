...
public class SearchbyFidRight_Result
{
    public SearchbyFidRight_ResultData[] Property1 { get; set; }
}

public class SearchbyFidRight_ResultData
{
    ...
    public SearchbyFidRight_ResultData_Birthday birthday { get; set; }
...
public class SearchbyFidRight_ResultData_Birthday
{
