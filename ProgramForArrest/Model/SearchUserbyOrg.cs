...
public class SearchUserbyOrg
{
    public SearchUserbyOrg_data[] Property1 { get; set; }
}

public class SearchUserbyOrg_data
{
    ...
    public SearchUserbyOrg_dataBirthday birthday { get; set; }
...
public class SearchUserbyOrg_dataBirthday
{
